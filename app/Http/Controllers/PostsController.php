...
class PostsController extends Controller
{
    ...
    {
        $data = PostsModel::all();
        return view("posts.home", compact("data"));
    }
    ...
    public function create()
    {
        ...
        $tags = TagModel::all();
        return view("posts.create_data", compact('categories', 'tags'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('posts.detail_post', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = CategoryModel::all();
        $tags = TagModel::all();
        return view('posts.edit_data', compact('data', 'categories', 'tags'));
    }
